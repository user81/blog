...
/*function new_topic($user, $topic, $message, $email, $date){
    global $link;
...
function update_topic($user, $topic, $message, $email, $id_post){
    global $link;
    $connect = new mysql_connection;
...
function comment($topic_user, $topic_email, $topic_message, $topics_id, $date_comments)
{
    global $link;
    $connect = new mysql_connection;
...
function update_comments($topic_user, $topic_email, $topic_message, $topics_id)
{
    global $link;
    $connect = new mysql_connection;
...
function delete_comments( $comments_id)
{
    global $link;
    $connect = new mysql_connection;
    $delete_post_stmt = mysqli_prepare($link, "DELETE FROM `comments` WHERE `id` =?");
    mysqli_stmt_bind_param($delete_post_stmt, 'i',  $comments_id);
